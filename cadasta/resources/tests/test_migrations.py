...
class MigrationTestCase(UserTestCase, TestCase):
    ...
    def setUp(self):
        ...
        call_command('migrate', 'accounts',
                     '0002_activate_users_20161014_0846', interactive=False)
        call_command('migrate', self.app, self.migrate_from, interactive=False)

        # setup pre-migration test data
        self.setUpBeforeMigration(apps_before)

        # Run the migration to test
        call_command('migrate', self.app, self.migrate_to, interactive=False)
