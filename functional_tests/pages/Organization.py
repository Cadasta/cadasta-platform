...
class OrganizationPage(Page):
    ...
    def get_org_description_and_members(self):
        return self.get_container(
            "//div[contains(@class, 'org-desc-members')]")

    def get_edit_button(self):
        return self.get_container("//a[@class='edit']")
    ...
    def get_project_title(self):
        return self.get_container("//div[contains(@class, 'project-name')]")

    def get_users_page(self):
        return self.test.link("view-all")

    def get_welcome_message(self):
        return self.get_container("//div[contains(@class, 'org-proj-list')]")

    def get_new_project(self):
        return self.test.link("add-new-project")
